...
public final class PandorasHybridBox<Key: Hashable & Sendable, Value: Codable & Sendable>: PandorasHybridBoxProtocol {

    public let namespace: String

    private let memory: PandorasMemoryBox<Key, Value>
    private let disk: PandorasDiskBox<Key, Value>
    ...
    public init(
        ...
        self.memory = PandorasMemoryBox<Key, Value>(maxSize: memoryMaxSize, expiresAfter: memoryExpiresAfter)
        self.disk = PandorasDiskBox<Key, Value>(namespace: namespace, maxSize: diskMaxSize, expiresAfter: diskExpiresAfter)
    ...
    internal init(
        ...
        disk: PandorasDiskBox<Key, Value>,
        memoryExpiresAfter: TimeInterval? = nil,
        diskExpiresAfter: TimeInterval? = nil,
